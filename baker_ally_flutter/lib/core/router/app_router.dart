...
/// Grows as Cart/Checkout/Orders/Wishlist/Addresses screens are built in
/// later milestones -- see 00_common_architecture.md §2's redirect example.
const _protectedPaths = ['/cart'];
    ...
    routes: [
      ...
      StatefulShellRoute.indexedStack(
        ...
        branches: [
          ...
          StatefulShellBranch(routes: [
            GoRoute(path: '/cart', builder: (c, s) => const PlaceholderScreen(title: 'Cart')),
          ]),
        ],
      ),
    ],
